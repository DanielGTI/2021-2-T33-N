...
O grupo deve escolher a linguagem de programação ou framework que julgar necessária a execução do projeto proposto.  
...
No **Titulo** do email informar apenas: **Entrega T33-projeto**
...
## Contato
Em caso de dúvidas encaminhe-me um e-mail, sempre informando seu **RA**, **Nome** e o nome deste repositório **(T33-projeto)** no título da mensagem.
